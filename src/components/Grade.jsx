            ...
            <div className="mt-1 w-full h-full flex items-end">
                <div className="w-full flex">
                    <textarea rows="1" inputMode="numeric"
                        className="no-scrollbar resize-none w-full h-7 text-center pt-[0.15rem] text-sm outline-none rounded-lg border dark:text-slate-300 text-slate-700 dark:border-slate-400 border-slate-500 bg-transparent dark:placeholder-slate-500 placeholder-slate-450"
                        placeholder="Grade"
                        value={inputValue}
