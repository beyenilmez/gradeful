    ...
    return (
        ...
        >
            {universityData.terms.map((term) => (
                <Term key={term.id} id={term.id} name={term.name} totalCredit={term.totalCredit} totalEcts={term.totalEcts} expanded={term.expanded} includeCalc={term.includeCalc} autoCalc={term.autoCalc} gpa={String(term.gpa)}>
                    <ReactSortable
                        list={term.courses}
                        setList={(newList) => {
